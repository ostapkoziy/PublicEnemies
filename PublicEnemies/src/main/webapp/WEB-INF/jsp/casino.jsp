...
<body>
	<table align="center">
		...
		<tr>
			<table id="main_table" class="sample" align="center" width="500"
				height="600">
				<tr>
					<td><img id="blackjack" class="highlight"
						style="position: relative; left: -200px"
						src="img/casino-blackjack.png" alt="Submit button"></img></td>
					<td><img id="poker" class="highlight"
						style="position: relative; left: 0px" src="img/casino-poker.png"
						alt="Submit button"></img></td>
					<td><img id="roulette" class="highlight"
						style="position: relative; left: 200px"
						src="img/casino-roulette.png" alt="Submit button"></img></td>
				</tr>
				<tr>
					<td>

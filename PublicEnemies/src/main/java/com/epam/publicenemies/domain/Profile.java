...
import com.epam.publicenemies.dao.impl.ProfileDaoImpl;
...
public class Profile {
	 ...
	 * @param character - uCharacter object
	 */
	 ...
	 * @param keys - id's of injection in trunk table 
	 * @param uWeapons - Weapon objects from trunk  
	 */
	 ...
	 * @param keys - id's of injection in trunk table 
	 * @param uWeapons - Aid objects from trunk  
	 */
	 ...
	 * @param keys - id's of injection in trunk table 
	 * @param uWeapons - Armor objects from trunk  
	 */
	public void fillArmorsMap(List<Integer> keys, List<Armor> uArmors) {
		for (int i = 0; i<keys.size(); i++ ) putArmor(keys.get(i), uArmors.get(i));
	 ...
	 * @param id - id of trunk table injection
	 * @param weapon - Weapon object
	 */
	...
	/**
	 * Set user's strength
	 * @param strength - amount of user's strength
	 */
	...
	/**
	 * Set user's agility
	 * @param agility - amount of user's agility
	 */
	 ...
	 * @param intellect - amount of user's intellect
	 */
	 ...
	 * @param profileId - id of user's character
	 */
